...
def test_strategy_2(rec, expected):
    assert day4.strategy_2(rec) == expected
...
def test_sort_records():
    ...
    shuffled = '\n'.join(shuffled)
    assert day4.sort_records(shuffled) == records.splitlines()


@pytest.mark.parametrize("record, expected", [
    ('[1518-11-01 00:00] Guard #10 begins shift', date(1518, 11, 1)),
    ('[1518-11-02 00:50] wakes up', date(1518, 11, 2)),
    ('[1518-11-01 23:58] Guard #99 begins shift', date(1518, 11, 2))
])
